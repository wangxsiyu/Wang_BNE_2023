function game = rattask_EEsound_magnitudeGLong(folder, ratname, fdtime, fddrops, homebases, horizons, guideds, nRep)
    if ~exist('folder')
        folder = './';
    end
...
%     fprintf(fileID, 'PureTone-11kHz , a*sin((w-w*t/11)*t) , 1000, 11000, %d\n', volume);
    fprintf(fileID, 'PureTone-11kHz , a*sin((w)*t) , 1000, 9000, %d\n', volume);
