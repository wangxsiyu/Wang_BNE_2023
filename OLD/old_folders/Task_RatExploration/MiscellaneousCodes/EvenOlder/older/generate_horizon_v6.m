function [feeders, rewards] = generate_horizon_v6(N, cond_horizon, steplevel, levels, folder)
%   N - number of trials
...
rand('seed', sum(clock()));
outputfile = strcat('taskset_horizonv5_h', num2str(cond_horizon(1)),'_',num2str(cond_horizon(2)), '_', datestr(now,30),'.txt');
